export default function Privacy() {
  return (
    <main style={styles.main}>
      ...
      <p style={styles.p}>
        Essay text is sent to Anthropic's Claude API solely to generate the feedback you asked for.
        Your email is used only to track how many free reviews you've used and whether you're
        subscribed. We do not use your essays to train any AI model, and we do not store your
        essay text on our servers after your feedback is generated and sent back to you.
      </p>
      ...
      <p style={styles.p}>
        You can request your account and usage record be deleted at any time by emailing{' '}
        <a href="mailto:hello@admitly.io">hello@admitly.io</a>.
      </p>
